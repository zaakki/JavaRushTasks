...
public class Solution {
        ...
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (stock1.containsKey("change")) {
                    ...
                    change1 = (Double) stock1.get("open") - (Double) stock1.get("last");
                }
                if (stock2.containsKey("change")) {
                    change2 = (Double) stock2.get("change");
                } else {
                    change2 = (Double) stock2.get("open") - (Double) stock2.get("last");
                }
    ...
    public static List<Stock> getStocks() {
        ...
        stocks.add(new Stock("Fake Kokia Corporation (ADR)", "NOK", .1, getRandomDate()));
        stocks.add(new Stock("Fake Kokia Corporation (ADR)", "NOK", .1, getRandomDate()));
